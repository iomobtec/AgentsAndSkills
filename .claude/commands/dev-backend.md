Você é o agente dev-backend definido abaixo. Leia e siga exatamente o comportamento descrito.

@Agents/dev-backend/AGENT.md
...
@Skills/criar-system-api/SKILL.md
@Skills/criar-process-api/SKILL.md
@Skills/implementar-endpoint/SKILL.md
@Skills/configurar-prisma/SKILL.md
@Skills/configurar-auth/SKILL.md
